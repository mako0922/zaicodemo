  ...
  <div class="container">
    <div class="row mb-5">
      ...
      <div class="col-8">
        ...
        <h2>
          <input type="radio" name="revision_number" value="{{$revision_number_auto}}" id="radio-0" @if(empty(old('revision_number'))) checked  @elseif(empty($revision_number_old) and empty($info -> revision_number)) checked @endif onClick="changeDisabled()"><label for="radio-0">自動採番:   {{$revision_number_auto}}</label>&nbsp;<br>
          <input type="radio" name="revision_number" value="その他" id="radio-other" @if(!empty(old('revision_number'))) checked @elseif(!empty($revision_number_old) or !empty($info -> revision_number)) checked @endif onClick="changeDisabled()"><label for="radio-other">手動採番</label>&nbsp;
          <p style="display:inline;"><input type="text" name="revision_number" @if(!empty(old('revision_number'))) value="{{old('revision_number')}}" @elseif(!empty($revision_number_old)) value="{{$revision_number_old}}" @elseif(!empty($info -> revision_number))value="{{$info -> revision_number}}"@endif></p>
        </h2>
        @else
        <input type="hidden" name="revision_number" @if(!empty(old('revision_number'))) value="{{old('revision_number')}}" @elseif(!empty($revision_number_old)) value="{{$revision_number_old}}" @elseif(!empty($info -> revision_number))value="{{$info -> revision_number}}"@endif>
        <h2> @if(!empty(old('revision_number'))){{old('revision_number')}} @elseif(!empty($revision_number_old)){{$revision_number_old}}@elseif(!empty($info -> revision_number)){{$info -> revision_number}}@endif</h2>
        @endif
      </div>
    </div>
    <div class="row mb-5">
      ...
      <div class="col-8">
        @if($users->authority == 10)
        <h2><input type="text" name="part_name" @if(!empty(old('part_name'))) value="{{old('part_name')}}" @elseif(!empty($part_name_old)) value="{{$part_name_old}}" @elseif(!empty($info -> part_name))value="{{$info -> part_name}}"@endif></h2>
        @else
        <input type="hidden" name="part_name" @if(!empty(old('part_name'))) value="{{old('part_name')}}" @elseif(!empty($part_name_old)) value="{{$part_name_old}}" @elseif(!empty($info -> part_name))value="{{$info -> part_name}}"@endif>
        <h2>@if(!empty(old('part_name'))){{old('part_name')}}@elseif(!empty($part_name_old)){{$part_name_old}}@elseif(!empty($info -> part_name)){{$info -> part_name}}@endif</h2>
        @endif
      </div>
    </div>
    <div class="row mb-5">
    ...
    <div class="row mb-5">
      ...
      <div class="col-8">
        @if($users->authority == 10)
        <h2><input type="number" name="stock" min="0" @if(!empty(old('stock'))) value="{{old('stock')}}" @elseif(!empty($stock_old)) value="{{$stock_old}}" @elseif(!empty($info -> stock))value="{{$info -> stock}}"@else value="0"@endif></h2>
        @else
        <input type="hidden" name="stock" @if(!empty(old('stock'))) value="{{old('stock')}}" @elseif(!empty($stock_old)) value="{{$stock_old}}" @elseif(!empty($info -> stock))value="{{$info -> stock}}"@else value="0" @endif>
        <h2>@if(!empty(old('stock'))){{old('stock')}}@elseif(!empty($stock_old)){{$stock_old}}@elseif(!empty($info -> stock)){{$info -> stock}} @else 0 @endif</h2>
        @endif
      </div>
    </div>
    <div class="row mb-5">
