  ...
  <div class="container">
    <div class="row mb-5">
      ...
      <div class="col-8">
        ...
        <h2>
          <input type="radio" name="revision_number" value="{{$revision_number_auto}}" id="radio-0" checked onClick="changeDisabled()"><label for="radio-0">自動採番:   {{$revision_number_auto}}</label>&nbsp;<br>
          <input type="radio" name="revision_number" value="その他" id="radio-other" onClick="changeDisabled()"><label for="radio-other">手動採番</label>&nbsp;
          <p style="display:inline;"><input type="text" name="revision_number" value=""></p>
        </h2>
        @else
    ...
    <div class="row mb-5">
      ...
      <div class="col-8">
        @if($users->authority == 10)
        <h2><input type="text" name="part_name" @if(!empty($part_name_old)) value="{{$part_name_old}}" @elseif(!empty($info ->  part_number))value="{{$info ->  part_number}}"@endif></h2>
        @else
        <input type="hidden" name="part_name" @if(!empty($part_name_old)) value="{{$part_name_old}}" @elseif(!empty($info ->  part_number))value="{{$info ->  part_number}}"@endif>
        <h2>@if(!empty($part_name_old)){{$part_name_old}}@elseif(!empty($info ->  part_number)){{$info ->  part_number}}@endif</h2>
        @endif
      </div>
    </div>
    <div class="row mb-5">
    ...
    <div class="row mb-5">
      ...
      <div class="col-8">
        <h2><textarea name="comment" placeholder="フリーコメントを記入ください" style="width:373px; height:500px;">@if(!empty($comment_old)) {{$comment_old}} @elseif(!empty($info -> comment)){{$info -> comment}}@endif</textarea></h2>
      </div>
    </div>
    <div class="row mb-5">
      <div class="col-4">
